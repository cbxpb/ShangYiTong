<template>
  <div class="detail">
    ...
    <div class="logo">
      <div class="left">
        <img v-if="hospitalInfoStore.hospitalInfo?.hospital?.logoData"
      ...
      <div class="right">
        ...
        <div class="route">
          规划路线:{{ hospitalInfoStore.hospitalInfo?.hospital?.route }}
        </div>
      </div>
    </div>
    <!-- 医院介绍 -->
    <div class="footer">
      <h1>医院介绍</h1>
      <p>
        {{ hospitalInfoStore.hospitalInfo?.hospital?.intro }}
      </p>
    </div>
  </div>
</template>
